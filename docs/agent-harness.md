...
including owned child processes; only confirmed zero active processes permits
confirmed stopping. Stopping never undoes filesystem, registry, network, or other
script side effects.
