...
RMM_RATE_TEST=1 .venv/bin/python -m pytest -q tests/control_plane/test_logging.py tests/control_plane/test_pairing.py tests/control_plane/test_reachability.py
